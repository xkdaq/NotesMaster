...
public class FaceDetectRoundView extends View {
    ...
    public static final int COLOR_ROUND = Color.parseColor(Constants.LIVENESS_COLOR_PRIMARY);
    ...
    public FaceDetectRoundView(Context context, AttributeSet attrs) {
        ...
        float pathSpace = CommonUtils.dip2px(context, PATH_SPACE);
        float pathSmallSpace = CommonUtils.dip2px(context, PATH_SMALL_SPACE);
        float pathWidth = CommonUtils.dip2px(context, PATH_WIDTH);
